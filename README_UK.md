...
- `turn_spoof_vendingSDK` - увімкнення/вимкнення додавання параметра підміни vendingSDK в PIF файлі (за замовчуванням: on для Android 13+ та off для старіших версій)
